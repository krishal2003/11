...
export default function EventsPage() {
  const upcomingEvents = [
    {
      slug: "https://www.usanepalgastronomychefsassociation.com/",
      date: "NOV 9, 2025",
      title: "US-NEPAL GASTRONOMY 2025",
      location: "Aloft Kathmandu, Thamel",
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-16 ">
              ...
              <h1 className="text-white font-serif text-5xl md:text-7xl font-bold leading-tight mb-8">
                UPCOMING
                <br />
                <span className="text-primary">PROJECTS & BEYOND</span>
              </h1>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {upcomingEvents.map((event, index) => (
                  <Link key={index} href={event.slug} target="_blank">
